...
from body.urls.mybody import ENTRY_UPDATE_ROUTE
from freezegun import freeze_time


@freeze_time(make_aware(datetime(2022, 3, 1)))
class EntryUpdateViewTests(LoginTestCase):
    def test_has_data(self):
        ...
        response = self.client.get(
            reverse(ENTRY_UPDATE_ROUTE, kwargs={"reportpk": report.pk, "pk": entry.pk})
        )
